 ...
 * @author Alexis
 */
@WebServlet(urlPatterns = {"/ValidarUsuario"})
public class ValidarUsuario extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       String ID_Sesion,username="",pass="";
       ...
       password = request.getParameter("password");
        ...
        if(cookie!=null){
            for(Cookie cookie_usuario: cookie){
                if("ID_Sesion".equals(cookie_usuario.getName())){
                    ID_Sesion=cookie_usuario.getValue();
                }
                if("Username".equals(cookie_usuario.getName())){
                    username=cookie_usuario.getValue();
                }
       ...
       if(nombre.equalsIgnoreCase(username)){
           ...
           if(password.equalsIgnoreCase(pass)){
               ...
               Usuarios usuarios = new Usuarios(nombre,password);
